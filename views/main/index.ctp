<section id="main">
    ...
    <section id="otros_servicios">
        ...
        <article id="servicios_col02">
			...
			<div class="contenido">
            	<p><a href="#;">Confección y venta de  ropa corporativa  para Empresas, Colegios,  Grupos, Eventos, etc. Contamos con máquinas propias y profesionales para diseñar y bordar tu pedido, (...). Para más información click aquí.</a></p>
			</div>
        </article>
	</section>
    <!--END OTROS SERVICIOS-->
