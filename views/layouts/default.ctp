...
<section id="center" class="home">	
	<div class="wrap">
		<section id="big-banner" class="col_8 col">
			<?php echo $html->image('bann_01.png', array('alt' => '', 'width' => '450', 'height' => '345', 'url' => array('controller' => 'dashboard'))); ?>
		</section>
		...
		<section id="news-works" class="col_8 col">
			...
			<ul id="design" class="left">
	    		<li class=""><a href="#"><?php echo $html->image('demo/01.jpg'); ?></a></li>
	    		<li class=""><a href="#"><?php echo $html->image('demo/02.jpg'); ?></a></li>
	    		<li class=""><a href="#"><?php echo $html->image('demo/03.jpg'); ?></a></li>
	    		<li class=""><a href="#"><?php echo $html->image('demo/04.jpg'); ?></a></li>
	    		<li class=""><a href="#"><?php echo $html->image('demo/05.jpg'); ?></a></li>
	    		<li class=""><a href="#"><?php echo $html->image('demo/06.jpg'); ?></a></li>
	    		<li class=""><a href="#"><?php echo $html->image('demo/07.jpg'); ?></a></li>
	    		<li class=""><a href="#"><?php echo $html->image('demo/08.jpg'); ?></a></li>
	    		<li class=""><a href="#"><?php echo $html->image('demo/09.jpg'); ?></a></li>
	    		<li class=""><a href="#"><?php echo $html->image('demo/10.jpg'); ?></a></li>
	    		<li class=""><a href="#"><?php echo $html->image('demo/11.jpg'); ?></a></li>
	    		<li class=""><a href="#"><?php echo $html->image('demo/12.jpg'); ?></a></li>
	    	</ul>
	    </section>
	</div>
</section>
