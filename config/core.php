 ...
 */
	//Configure::write('Routing.prefixes', array('admin', 'clientes'));
 ...
 */
	Configure::write('Security.salt', 'kljsadhofiuyaspi9df8upbasoiudfp089ausbpndoifuha');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '521651321065846516351464651646846');
